	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>				
					<li class="<?php echo $__env->yieldContent('colorlib_home'); ?>"><a href="/dashboard">Profil</a></li>
					<li class="<?php echo $__env->yieldContent('colorlib_posttask'); ?>"><a href="/posttask">Unggah Pekerjaan Baru(poster)</a></li>
					<li class="<?php echo $__env->yieldContent('colorlib_browsetask'); ?>"><a href="/browsetask">Lowongan Tersedia (worker)</a></li>
					<li class="<?php echo $__env->yieldContent('colorlib_mytask'); ?>"><a href="/mytask">Pekerjaan Saya</a></li>
					<li class="<?php echo $__env->yieldContent('colorlib_offertask'); ?>"><a href="/postoffer">Tawaran Saya (Worker)</a></li>
					<!-- <li class="<?php echo $__env->yieldContent('colorlib_offertask'); ?>"><a href="/postoffer">Tawaran yang dikirim (worker)</a></li> -->
					<li class="<?php echo $__env->yieldContent('colorlib_message'); ?>"><a href="/message">Pesan</a></li>
					<li class="<?php echo $__env->yieldContent('colorlib_helptask'); ?>"><a href="/reportmessage">Bantuan dan Pelaporan</a></li>
