...
<?php if($crud->hasAccess('list')): ?>
	<a href="<?php echo e(url($crud->route)); ?>" class="hidden-print"><i class="fa fa-angle-double-left"></i> <?php echo e(trans('backpack::crud.back_to_all')); ?> <span><?php echo e($crud->entity_name_plural); ?></span></a>
<?php endif; ?>
