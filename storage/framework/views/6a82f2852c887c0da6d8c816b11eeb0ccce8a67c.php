		...
		<div class="colorlib-narrow-content">
					<div class="row">
							<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
								...
								<?php endif; ?>
								<?php endif; ?>
								<?php if($taskdetails->status != 'assigned' && $taskdetails->status != 'finished' && $uid == $taskdetails->posted_by_id): ?>
								...
								<?php if($taskdetails->status == 'assigned' && $today <= $deadlinecancel && $uid == $taskdetails->posted_by_id): ?>
				...
				<?php endif; ?>
					<div class="col-md-7 col-md-push-1">
						<div class="colorlib-narrow-content">
							...
							<?php if($taskdetails->status == 'not assigned' && $taskdetails->assigned_tasker_id == $uid): ?>
							<input type="button" onclick="location.href='acceptjob/<?php echo e($taskdetails->id); ?>';" target="_blank" class="btn btn-info col-md-10" value="accept the job">
							<input type="button" onclick="location.href='rejectjob/<?php echo e($taskdetails->id); ?>';" target="_blank" class="btn btn-info col-md-10" value="reject the job">	
							<?php endif; ?>
							<?php if($taskdetails->status == 'assigned' && $taskdetails->assigned_tasker_id == $uid && $today <= $deadlinecancel): ?>
							<input type="button" onclick="location.href='cancelaccept/<?php echo e($taskdetails->id); ?>';" target="_blank" class="btn btn-info col-md-10" value="cancel your participation on this task">
							<?php endif; ?>
							<?php if($taskdetails->status == 'reported' && $taskdetails->assigned_tasker_id == $uid): ?>
							<input type="button" onclick="location.href='reportjob/<?php echo e($taskdetails->id); ?>';" target="_blank" class="btn btn-info col-md-10" value="report to admin">	
							<?php endif; ?>
							<?php if($taskdetails->status == 'reported' && $taskdetails->posted_by_id == $uid): ?>
							<input type="button" onclick="location.href='reportjob/<?php echo e($taskdetails->id); ?>';" target="_blank" class="btn btn-info col-md-10" value="report to admin">	
							<?php endif; ?>
							<?php if($taskdetails->status == 'assigned' && $taskdetails->due_date == $today): ?>
							<?php if($taskdetails->poster_acc == 'arrived' && $taskdetails->worker_acc == 'arrived'): ?>
							<?php if($taskdetails->posted_by_id == $uid): ?>
							<input type="button" onclick="location.href='poster_com/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="worker has finished the job">	
							<input type="button" onclick="location.href='poster_fail/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="worker has failed to finish job">			
							<?php endif; ?>
							<?php endif; ?>
							<?php if($taskdetails->poster_acc == 'completed'): ?>
							<?php if($taskdetails->assigned_tasker_id == $uid): ?>
							<input type="button" onclick="location.href='worker_com/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="i has finished the job">
							<input type="button" onclick="location.href='worker_fail/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="i has failed to finished the job">		
							<?php endif; ?>
							<?php endif; ?>
							<?php if($taskdetails->poster_acc == 'fail'): ?>
							<?php if($taskdetails->assigned_tasker_id == $uid): ?>
							<input type="button" onclick="location.href='worker_com/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="i has finished the job">
							<input type="button" onclick="location.href='worker_fail/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="i has failed to finished the job">		
							<?php endif; ?>
							<?php endif; ?>
							<?php if($taskdetails->posted_by_id == $uid && $taskdetails->poster_acc == ''): ?>
							<input type="button" onclick="location.href='poster_acc/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="worker has arrived">		
							<?php elseif($taskdetails->assigned_tasker_id == $uid && $taskdetails->worker_acc == ''): ?>
							<input type="button" onclick="location.href='worker_acc/<?php echo e($taskdetails->id); ?>';" class="btn btn-info col-md-10" value="i has arrived">		
							<?php endif; ?>
							<?php endif; ?>
							<?php if($taskdetails->posted_by_id == $uid && $taskdetails->status == 'not assigned' && $taskdetails->due_date > $today && $taskdetails->assigned_tasker_id == ''): ?>
