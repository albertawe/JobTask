						...
						<div class="colorlib-narrow-content">
							<div class="row">
								...
								<div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
									<form method="post" action="<?php echo e(url('postwithdraw')); ?>" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
										...
										<?php endif; ?>
											<input type="number" value="" id="number" min="0" max="<?php echo e($max); ?>" oninput="validity.valid||(value=value.replace(/\D+/g, ''))" class="form-control" placeholder="offer your price" name="price">
										</div>
										<div class="form-group">
